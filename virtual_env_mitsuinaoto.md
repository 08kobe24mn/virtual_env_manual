...
今回環境構築していく中で、何度かエラーが表示されることがありました。  
エラーメッセージは全て英語で、読むのが嫌になることもありました。  
しかし、しっかり読み込み、検索をかければ、自力でも解決できました。  
学んだことは大きく2つ。  
エラーメッセージをしっかり読み込むことで解決に繋がるということ。  
そして、英語の勉強をすることが必要だということです。  
